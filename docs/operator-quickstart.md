# Operator Quickstart — Manufacture of man-made fibres

Shortest path from clone to a verified local dry-run for **ISIC 2030** (`cloud-itonami-isic-2030`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2030.git
cd cloud-itonami-isic-2030
```
...
- Blueprint governor key: `man-made-fibre-plant-operations-governor`
- Likely source path: `fibremfg.governor.cljc`
