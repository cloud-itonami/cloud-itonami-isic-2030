# Business Model: Manufacture of man-made fibres
...
## Classification
- Repository: `cloud-itonami-isic-2030` ([github.com/cloud-itonami/cloud-itonami-isic-2030](https://github.com/cloud-itonami/cloud-itonami-isic-2030))
- ISIC Rev.5: `2030` — Manufacture of man-made fibres
- Domain: `:man-made-fibre/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:man-made-fibre-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :man-made-fibre/manufacturing — who wants
...
Capability stack (required): :robotics :identity :forms :dmn :bpmn :audit-ledger :cae :cfd.
...
One managed tenant (:man-made-fibre/manufacturing):
...
- Do not bypass the `:man-made-fibre-plant-operations-governor` for production decisions.
